package lys.threads.javathreads.examples.ch03.example1;

import javax.swing.JLabel;
import javax.swing.SwingUtilities;

import lys.threads.javathreads.examples.ch02.CharacterEvent;
...
public class ScoreLabel extends JLabel implements CharacterListener {
	...
	public synchronized void newCharacter(CharacterEvent ce) {
		...
		// If character is extraneous: 1-point penalty // If character does not
		// match: 1-point penalty else {
